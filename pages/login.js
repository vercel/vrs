    ...
    <main className="pa3 pa5-ns vh-100 w-100 white dt tc">
      <p className="f4 lh-copy measure dtc v-mid">
        ...
        <a href="/auth/twitter" className="white no-underline">
          <span className="v-mid">Login with Twitter</span>
          <br/>
          <svg className="dib mt3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#357edd" style={{width: '2em', height: '2em', fill: '#357edd'}}>
